...
@section('content')
    ...
    <div class="container">
        <h1 class="text-center my-4">Celebrating 31 Years of Arts Education</h1>
        <p>
        ...
        <div class="row gradient-splash text-white p-5 rounded shadow">
            ...
            <div class="col-sm-9">
                ...
                <p>
                    ...
                    <br><br>
                    As well as overseeing daily operations at the studio, teaching a few classes and directing the Powerhouse Dance Team, she works for Brevard Public Schools during the day as a Guidance Services Professional. In her limited free time, she enjoys the beach, traveling, and playing with her Maine Coons, Stormy and Kimba, and her Blue Frenchies Luna and Zoey.
                    <br><br>
