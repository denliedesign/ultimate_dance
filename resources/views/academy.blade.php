...
{{--                <x-room room="" day="Monday" time="7:00pm-7:45pm" name="Leaps/Turns" age="5-8 (Grade K-3)" staff="AA"/>--}}
            ...
            <table class="table">
                ...
                <x-room room="" day="Tuesday" time="5:00pm-6:00pm" name="Ballet" age="beg/int ages 9-11 (Grade 4-6)" staff="SB"/>
            ...
            <h2>Wednesday</h2>
            <table class="table">
                <x-room room="" day="Wednesday" time="5:00pm-6:00pm" name="Jazz" age="ages 7-8 (Grade 2-3)" staff="AS"/>
                ...
                <x-room room="" day="Wednesday" time="6:00pm-7:00pm" name="Tap" age="ages 7-8 (Grade 2-3)" staff="KR"/>
                <x-room room="" day="Wednesday" time="7:00pm-8:00pm" name="Musical Theater" age="ages K5-11 (Grades K-5)" staff="KR"/>
