...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-sm my-3 shadow rounded mx-2 p-3">
                <strong><u>2021-2022 TUITION SCHEDULE</u></strong>
                <br>1ST HOUR $80
                <br>
                2ND - 5TH HOUR $40 (50% DISCOUNT!)
                <br>
                6TH - 10TH HOUR $20 (75% DISCOUNT!)
                <br>
                11TH HOUR AND ABOVE  FREE!!!
                <br>
                <em>*The software system will divide incremental hours accordingly</em>
                <br><br>
                ANNUAL MEMBERSHIP FEE
                <br>
                $30 individual or $50 family
                <br><br>
        ...
        <div class="gradient-splash my-5 rounded shadow p-3">
            <div class="row text-white">
                <h1 class="text-center">2022-2023 Fall Schedule</h1>
                <div class="col-sm">
                    <h4 class="nic txt-gold">Room 1</h4>
                    <p class="fw-bold pb-0 mb-0" style="font-size: 1.5em;">Monday</p>
                    <p>Schedule coming soon</p>
                </div>
                <div class="col-sm">
                    <h4 class="nic txt-gold">Room 2</h4>
                    <p class="fw-bold pb-0 mb-0" style="font-size: 1.5em;">Monday</p>
                    <p>Schedule coming soon</p>
                </div>
            </div>
