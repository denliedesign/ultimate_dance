    ...
    <div class="container">
        ...
        <div class="my-5 p-3">
            ...
            <table class="table">
                ...
                <x-room room="" day="Wednesday" time="5:00pm-6:00pm" name="Adv Tap" age="ages 10+" staff="KR"/>
            ...
            <table class="table">
                ...
                <x-room room="" day="Thursday" time="5:00pm-6:00pm" name="Beg Hip Hop" age="ages K5-10" staff="ASH"/>
                <x-room room="" day="Thursday" time="6:00pm-7:00pm" name="Hip Hop" age="ages 12-18 (Grade 6-12)" staff="ASH"/>
                <x-room room="" day="Thursday" time="6:00pm-7:00pm" name="Top Gun" age="ages 12+ (Grade 7-12)" staff="ASH"/>
                ...
                <x-room room="" day="Thursday" time="8:00pm-9:00pm" name="Int/Adv Hip Hop" age="ages 9+" staff="ASH"/>
            </table>
            <h2>Friday</h2>
            <table class="table">
