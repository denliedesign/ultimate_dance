...
{{--    </div>--}}
    ...
    <div class="gradient-splash text-white" style="min-height: 85vh; max-height: 100%;">
        <div class="container">
            <div class="row py-5">
                <div class="col-sm">
                    <h2 class="text-center">Reader's Choice Award<br>7 YEARS IN A ROW!</h2>
                    <div class="row row-cols-4">
                        ...
                        <img src="/images/readers-choice-24-Photoroom.png" alt="readers choice 2024" class="img-fluid">
                        <img src="/images/readers-choice-2025.png" alt="readers choice 2025" class="img-fluid">
                    </div>
                </div>
